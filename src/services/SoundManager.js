System.register(['angular2/core', './SoundCloudPlayer.ts', '../interfaces/Events.ts', './SoundManagerSoundPlayer.ts', './PlaylistService.ts'], function(exports_1) {
    ...
    var core_1, SoundCloudPlayer_ts_1, Events_ts_1, SoundManagerSoundPlayer_ts_1, PlaylistService_ts_1;
    var SoundManager;
    return {
        setters:[
            function (core_1_1) {
