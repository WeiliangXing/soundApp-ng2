System.register(['angular2/core', '../../services/SoundManager.ts'], function(exports_1) {
        ...
        execute: function() {
            TimeSeekerCmp = (function () {
                ...
                TimeSeekerCmp = __decorate([
                    ...
                    __metadata('design:paramtypes', [SoundManager_ts_1.SoundManager, core_1.ElementRef])
                ], TimeSeekerCmp);
                return TimeSeekerCmp;
            })();
            exports_1("TimeSeekerCmp", TimeSeekerCmp);
        }
    }
});
