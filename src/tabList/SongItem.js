System.register(["angular2/core", "angular2/common", "../services/PlaylistService.ts", "../services/SoundManager.ts"], function(exports_1) {
    ...
    var core_1, common_1, PlaylistService_ts_1, SoundManager_ts_1;
    var SongItemCmp;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            ...
            exports_1("SongItemCmp", SongItemCmp);
        }
    }
});
